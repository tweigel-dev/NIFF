...
def conv3x3(in_planes: int, out_planes: int, stride: int = 1, groups: int = 1, dilation: int = 1) -> nn.Conv2d:
    ...
    if stride == 2:
        ...
        if in_planes == out_planes == groups:
            ...
            return nn.Sequential(FreqConv_DW_fft(in_planes), FreqConv_1x1_ifft(in_planes, out_planes))
...
class ResNet(nn.Module):
    def __init__(
        ...
        self.conv1 = nn.Conv2d(input_dims, self.inplanes, kernel_size=7, stride=2, padding=3, bias=False)
